 ...
 *
 * Finally, run
 * $ npx hardhat run scripts/generateGridnodeWhitelist.js --network mainnet
 */
...
const gridnodeDS = require("../data/ds_gridnode_whitelist.json");
...
async function main() {
  ...
  for (let i = 0; i < addressList.length; i++) {
    try {
      ...
      const obj = _.cloneDeep(gridnodeDS);
