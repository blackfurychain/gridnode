...
gridnoded tx dispensation create ValidatorSubsidy output.json grid1syavy2npfyt9tcncdtsdzf7kny9lh777vuvqz8 --from grid1syavy2npfyt9tcncdtsdzf7kny9lh777vuvqz8 --yes --fees 150000fury --chain-id=localnet --keyring-backend=test
gridnoded tx dispensation run 29_grid1syavy2npfyt9tcncdtsdzf7kny9lh777vuvqz8 ValidatorSubsidy--from grid1syavy2npfyt9tcncdtsdzf7kny9lh777vuvqz8 --yes --fees 150000fury --chain-id=localnet --keyring-backend=test
sleep 8
...
gridnoded tx dispensation run 25_grid1syavy2npfyt9tcncdtsdzf7kny9lh777vuvqz8 ValidatorSubsidy --from grid1syavy2npfyt9tcncdtsdzf7kny9lh777vuvqz8 --yes --gas auto --gas-adjustment=1.5 --gas-prices 1.0fury --chain-id=localnet --keyring-backend=test
