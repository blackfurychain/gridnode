...
gridnoded tx dispensation create ValidatorSubsidy output.json did:fury:g1syavy2npfyt9tcncdtsdzf7kny9lh777gfgs92 --from did:fury:g1syavy2npfyt9tcncdtsdzf7kny9lh777gfgs92 --yes --fees 150000fury --chain-id=localnet --keyring-backend=test
gridnoded tx dispensation run 29_did:fury:g1syavy2npfyt9tcncdtsdzf7kny9lh777gfgs92 ValidatorSubsidy--from did:fury:g1syavy2npfyt9tcncdtsdzf7kny9lh777gfgs92 --yes --fees 150000fury --chain-id=localnet --keyring-backend=test
sleep 8
...
gridnoded tx dispensation run 25_did:fury:g1syavy2npfyt9tcncdtsdzf7kny9lh777gfgs92 ValidatorSubsidy --from did:fury:g1syavy2npfyt9tcncdtsdzf7kny9lh777gfgs92 --yes --gas auto --gas-adjustment=1.5 --gas-prices 1.0fury --chain-id=localnet --keyring-backend=test
