...
grided tx margin update-params \
  ...
  --force-close-fund-address=did:fury:g1syavy2npfyt9tcncdtsdzf7kny9lh777gfgs92 \
  --incremental-interest-payment-enabled=true \
  --incremental-interest-payment-fund-percentage=0.1 \
  --incremental-interest-payment-fund-address=did:fury:g1syavy2npfyt9tcncdtsdzf7kny9lh777gfgs92 \
