...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$COSMOS_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/cosmos.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_channel_id=$AKASH_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/akash.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$SENTINEL_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/sentinel.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$IRIS_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/iris.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$PERSISTENCE_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/persistence.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$CRYPTO_ORG_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/crypto-org.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$REGEN_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/regen.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$OSMOSIS_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/osmosis.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$JUNO_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/juno.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$IXO_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/ixo.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$LIKECOIN_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/likecoin.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$BITSONG_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/bitsong.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$BAND_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/band.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$EMONEY_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/emoney.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$EMONEY_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/emoney-eeur.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$TERRA_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/terra.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$TERRA_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/terra-uusd.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$SECRET_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/scrt.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$COMDEX_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/cdmx.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$HUAHUA_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/huahua.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$STARGAZE_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/ustars.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$BITCANNA_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/ubcna.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$STARNAME_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/uiov.json
...
gridnoded q tokenregistry generate -o json \
  ...
  --token_ibc_counterparty_channel_id=$EVMOS_COUNTERPARTY_CHANNEL_ID \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true | jq > $GRIDCHAIN_ID/aevmos.json

echo "\n\ngenerated entry for $EVMOS_CHAIN_ID"

cat $GRIDCHAIN_ID/aevmos.json | jq
