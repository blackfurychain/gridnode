...
import (
	...
	"github.com/Gridironchain/gridnode/x/margin/client/cli"
...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	cfg.NumValidators = 1
	encConfig := gridapp.MakeTestEncodingConfig()
	...
	// 	db := dbm.NewMemDB()
	// 	return gridapp.NewGridApp(log.NewTMLogger(log.NewSyncWriter(os.Stdout)), db, nil, true, map[int64]bool{}, val.Dir, 0, encConfig, gridapp.EmptyAppOptions{})
	// }
