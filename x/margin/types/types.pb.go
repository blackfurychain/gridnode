...
// source: gridnode/margin/v1/types.proto
...
func (Position) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b6eec67a5c97aa3b, []int{0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_b6eec67a5c97aa3b, []int{1}
}
...
type MTP struct {
	...
	Position                 Position                                `protobuf:"varint,12,opt,name=position,proto3,enum=gridnode.margin.v1.Position" json:"position,omitempty"`
...
func (*MTP) Descriptor() ([]byte, []int) {
	return fileDescriptor_b6eec67a5c97aa3b, []int{2}
}
...
func init() {
	proto.RegisterEnum("gridnode.margin.v1.Position", Position_name, Position_value)
	proto.RegisterType((*GenesisState)(nil), "gridnode.margin.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "gridnode.margin.v1.Params")
	proto.RegisterType((*MTP)(nil), "gridnode.margin.v1.MTP")
}

func init() { proto.RegisterFile("gridnode/margin/v1/types.proto", fileDescriptor_b6eec67a5c97aa3b) }

var fileDescriptor_b6eec67a5c97aa3b = []byte{
	...
	,
}
