...
const (
	...
	FlagMaxFuryLiquidityThreshold      = "maxFuryLiquidityThreshold"
	FlagMaxFuryLiquidityThresholdAsset = "maxFuryLiquidityThresholdAsset"
	FlagLiquidityProtectionEpochLength  = "epochLength"
	FlagCurrentFuryLiquidityThreshold  = "currentFuryLiquidityThreshold"
...
var (
	...
	FsMaxFuryLiquidityThreshold      = flag.NewFlagSet("", flag.ContinueOnError)
	FsMaxFuryLiquidityThresholdAsset = flag.NewFlagSet("", flag.ContinueOnError)
	...
	FsCurrentFuryLiquidityThreshold  = flag.NewFlagSet("", flag.ContinueOnError)
...
func init() {
	...
	FsMaxFuryLiquidityThreshold.String(FlagMaxFuryLiquidityThreshold, "", "Set max fury liquidity threshold value according to asset used in maxFuryLiquidityThresholdAsset")
	FsMaxFuryLiquidityThresholdAsset.String(FlagMaxFuryLiquidityThresholdAsset, "", "Set max fury liquidity threshold asset to use to determine native price (if set to 'fury' the threshold can be define as fury)")
	...
	FsCurrentFuryLiquidityThreshold.String(FlagCurrentFuryLiquidityThreshold, "", "Set current fury liquidity threshold value")
