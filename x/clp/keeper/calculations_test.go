...
func TestKeeper_CheckBalances(t *testing.T) {
	...
	const address = "did:fury:g1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd"
...
func TestKeeper_ExtractValuesFromPool(t *testing.T) {
	...
	err := gridapp.AddCoinsToAccount(types.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin, nativeCoin))
