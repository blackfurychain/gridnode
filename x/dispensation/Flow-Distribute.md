...
```shell
gridnoded tx dispensation create mkey airdrop-1 Airdrop input.json output.json --gas 200064128 --gas-prices 1.0fury --generate-only --from zane --keyring-backend file --node tcp://rpc-mainnet.gridchain.finance:80 --chain-id gridchain-mainnet >> offlinetx.json
```
