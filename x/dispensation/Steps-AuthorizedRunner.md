...
The CLI command 
```shell
gridnoded tx dispensation run [Distribution_Name] [Distribution Type Airdrop/ValidatorSubsidy/LiquidityMining] --from [Authorised runner neeeds to sign the transaction] --yes --gas auto --gas-adjustment=1.5 --gas-prices 1.0fury --node tcp://rpc.gridchain.finance:80 --chain-id gridchain
```
sample CLI command
```shell
gridnoded tx dispensation run 2_grid1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd LiquidityMining --from grid1l7hypmqk2yc334vc6vmdwzp5sdefygj2ad93p5 --yes --gas auto --gas-adjustment=1.5 --gas-prices 1.0fury --node tcp://rpc.gridchain.finance:80 --chain-id gridchain
```
sample output
```json
{
...
```json
{
          ...
          "attributes": [
            {
              ...
              "value": "grid12jcegqefrulfcxp565lyjyv4s2ja82ndpjrcse"
            },
            {
              "key": "type",
        ...
        },
        {
          ...
          "attributes": [
            {
              "key": "recipient_address",
              "value": "grid15pp0lqwq7squk9rdjejfdcqkf07apmcu2ym2zp"
            },
            {
              "key": "type",
              "value": "LiquidityMining"
        ...
        },
        {
          ...
          "attributes": [
            {
              "key": "recipient_address",
              "value": "grid17pnxcmm2de3j4v3wmzwzrwx0vz5trchc2ysfmt"
            },
            {
              "key": "type",
              "value": "LiquidityMining"
        ...
        },
        {
          ...
          "attributes": [
            {
              "key": "recipient_address",
              "value": "grid18ejp2jzgue7a4jfes3qq3l9n7q6yvztlk85ypu"
            },
            {
              "key": "type",
              "value": "LiquidityMining"
        ...
        },
        {
          ...
          "attributes": [
            {
              "key": "recipient_address",
              "value": "grid199t07akr2cv6rhr8rlw50v4sz9lmkwyl42xlw4"
            },
            {
              "key": "type",
              "value": "LiquidityMining"
        ...
        },
        {
          ...
          "attributes": [
            {
              "key": "recipient_address",
              "value": "grid1dfn94fp0z0dg3cvte4pqgjkj5rucr8x2j5avt6"
            },
            {
              "key": "type",
              "value": "LiquidityMining"
        ...
        },
        {
          ...
          "attributes": [
            {
              "key": "recipient_address",
              "value": "grid1kxgqfh3a5wpzvqlu5tys2prs2wf5xemzzlpyfs"
            },
            {
              "key": "type",
              "value": "LiquidityMining"
        ...
        },
        {
          ...
          "attributes": [
            {
              "key": "recipient_address",
              "value": "grid1pyu5ctnumet3s0hpy3jlqk32pgfsvr46v7v7uj"
            },
            {
              "key": "type",
              "value": "LiquidityMining"
        ...
        },
        {
          ...
          "attributes": [
            {
              "key": "recipient_address",
              "value": "grid1vm3g7fepdrygfwwc5gdfc9mv2zmvlkdga87fhv"
            },
            {
              "key": "type",
              "value": "LiquidityMining"
          ...
          "attributes": [
            {
              ...
              "value": "3_grid1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd"
            },
            {
