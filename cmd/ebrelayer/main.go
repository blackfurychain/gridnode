...
import (
	...
	ebrelayertypes "github.com/Gridironchain/gridnode/cmd/ebrelayer/types"
	flag "github.com/spf13/pflag"

	gridapp "github.com/Gridironchain/gridnode/app"
	"github.com/Gridironchain/gridnode/cmd/ebrelayer/contract"
	"github.com/Gridironchain/gridnode/cmd/ebrelayer/relayer"
...
func buildRootCmd() *cobra.Command {
	...
	initClientCtx := client.Context{}.
		...
		WithHomeDir(gridapp.DefaultNodeHome)
	...
	rootCmd.PersistentFlags().String(
		...
		"",
		"Path to a json file containing an array of gridchain denom => Ethereum symbol pairs",
	)
	rootCmd.PersistentFlags().String(
...
func replayEthereumCmd() *cobra.Command {
	...
	replayEthereumCmd := &cobra.Command{
		Use:     "replayEthereum [tendermintNode] [web3Provider] [bridgeRegistryContractAddress] [validatorMoniker] [validatorMnemonic] [fromBlock] [toBlock] [gridFromBlock] [gridEndBlock]",
...
func main() {
	if err := svrcmd.Execute(buildRootCmd(), gridapp.DefaultNodeHome); err != nil {
		switch e := err.(type) {
