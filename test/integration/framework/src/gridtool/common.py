...
def gridtool_logger(name: Optional[str] = None):
    # Shortening "gridtool.eth" to "eth" results in a name clash with "eth" dependencies for which we want to disable logging...
    # if name is not None:
...
__log = gridtool_logger(__name__)
