...
def test_ebrelayer_restart(
    ...
    balance = test_utilities.get_gridironchain_addr_balance(request.gridironchain_address, request.grided_node, "ceth")
    ...
    time.sleep(5)
    assert balance == test_utilities.get_gridironchain_addr_balance(request.gridironchain_address, request.grided_node,
                                                               "ceth")
...
def test_ethereum_transactions_with_offline_relayer(
    ...
    for a in new_addresses:
        test_utilities.wait_for_grid_account(a, basic_transfer_request.grided_node, 90)
        test_utilities.wait_for_gridironchain_addr_balance(a, "ceth", amount, basic_transfer_request.grided_node, 90)
...
def test_gridironchain_transactions_with_offline_relayer(
    ...
    for a in new_eth_addrs:
        ...
        gridironchain_balance = test_utilities.get_gridironchain_addr_balance(request.gridironchain_address, request.grided_node,
                                                                    "ceth")
