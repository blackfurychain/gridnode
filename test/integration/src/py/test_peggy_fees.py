...
def test_fee_charged_to_transfer_fury_to_efury(
    ...
    starting_ceth_balance = test_utilities.get_gridironchain_addr_balance(request.gridironchain_address, request.gridnoded_node,
                                                                     "ceth")
    burn_lock_functions.transfer_gridironchain_to_ethereum(request, credentials)
    ending_ceth_balance = test_utilities.get_gridironchain_addr_balance(request.gridironchain_address, request.gridnoded_node,
                                                                   "ceth")
