...
$basedir/gridironchain_logs.sh vagrant/data/logs/* > ${datadir}/gridtransactions.json &
$basedir/gridironchain_blocks.sh vagrant/data/logs/* > ${datadir}/gridblocks.json &
